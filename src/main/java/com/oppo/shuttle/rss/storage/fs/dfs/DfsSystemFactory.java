...
public class DfsSystemFactory implements FileSystemFactory {
    ...
    /**
     * Load the default hdfs file system,
     * please ensure that the HADOOP_HOME or HADOOP_CONF_DIR environment variables are set correctly
     */
    @Override
    public FileSystem create(URI uri, Ors2FilesystemConf conf) throws IOException {
        return new DfsFileSystem(uri, conf);
    }
}
