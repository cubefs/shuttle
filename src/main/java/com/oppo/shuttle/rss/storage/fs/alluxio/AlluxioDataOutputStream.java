 ...
 * @author oppo
 */
public class AlluxioDataOutputStream extends FSDataOutputStream {
    private final FileOutStream outputStream;

    public AlluxioDataOutputStream(FileOutStream outputStream) {
    ...
    public FileOutStream getAlluxioOutputStream() {
        return outputStream;
    }
